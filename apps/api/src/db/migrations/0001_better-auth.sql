...
CREATE UNIQUE INDEX "accounts_issuer_account_id_ux" ON "accounts" USING btree ("issuer","account_id");--> statement-breakpoint
CREATE INDEX "accounts_user_id_idx" ON "accounts" USING btree ("user_id");--> statement-breakpoint
CREATE UNIQUE INDEX "sessions_token_ux" ON "sessions" USING btree ("token");--> statement-breakpoint
